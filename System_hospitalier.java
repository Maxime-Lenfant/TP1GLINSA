...
public class System_hospitalier {
    ...
    private String analyserRequete(Requête requête) {
        //Cette methode va analyser la requête passée en argument et la retourne analysée
        return "requête analysée";
    }

    private String comparerDonnes() {
        //Cette méthode va comparer les données et retourne la chaine de caractère "Cluster trouvée"
